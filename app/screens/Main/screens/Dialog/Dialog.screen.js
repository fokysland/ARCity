...
import { View, FlatList, TextInput, ScrollView, KeyboardAvoidingView } from "react-native";
...
let parseMessageBlock = (msgBlock) => {
    ...
    msgBlock.messages.forEach(function (currentValue) {
        parsedMessages.push(<MessageItem authorAvatar={this.authorAvatar} isMy={this.isMy} style={ChatStyles.messageItem} isLast={currentValue.isLast} msgContent={currentValue.msgContent} time={currentValue.time} />);
    }, msgBlock);
        ...
        <View style={ChatStyles.mainContainer}>
            ...
            <FlatList
                ...
                <View style={ChatStyles.inputContainer}>
                    {clipIcon}
                    <TextInput style={ChatStyles.messageInput}
