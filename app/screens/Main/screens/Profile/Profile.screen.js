        ...
        <View style={ProfileStyles.mainContainer}>
            <View style={ProfileStyles.profileMainInfoContainer}>
                <View style={ProfileScreen.avatarContainer}>
                        ...
                        <Image source={varlamovProfileAvatar} style={ProfileStyles.profileAvatar} />
                        <TouchableOpacity activeOpacity={0.8} style={ProfileStyles.uploadNewAvatar}>
                ...
                <Header text="Илья Александрович Варламов" style={ProfileStyles.profileName} />
                ...
                <TouchableOpacity activeOpacity={0.8} style={ProfileStyles.subsctibeButton}>
                    <View style={ProfileStyles.subsctibeButtonBackground}>
                        <Header style={ProfileStyles.subsctibeButtonText} text="Подписаться" />
                    </View>
                </TouchableOpacity>
            </View>
            ...
            <View style={ProfileStyles.SelectedContent}>
                <ProfileInformation townName="Екатеринбург" idesCount="999к" CompletedIdeasCount="999к" LikesCount="999к" DislikesCount="999к" />
            </View>
        </View>
    );
}
